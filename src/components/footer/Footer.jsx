...
const Footer = () => {
    ...
    return (
    <Box>
    <Box sx={{display: 'grid', gridTemplateColumns: {xs: 'repeat(1, 1fr)', md: 'repeat(4, 1fr)', sm: 'repeat(2, 1fr)'}, gap: 2, px: {md: 10, xs: 2}, backgroundColor: {md: '#57FF98', xs: '#FFFFFF'}, py: 2, justifyContent: 'center'}}>
